...
class TicketSiteFees {
	...
	public function year_site_fees_add_plugin_page() {
		add_management_page(
			'Year Site Fees', // page_title
			'Year Site Fees', // menu_title
			'manage_options', // capability
			'year-site-fees', // menu_slug
			array( $this, 'year_site_fees_create_admin_page' ) // function
		);
	}

	public function year_site_fees_create_admin_page() {
		$this->year_site_fees_options = get_option( 'year_site_fees_option_name' ); ?>

		<div class="wrap">
			<h2>Year Site Fees</h2>
			<p></p>
			<?php settings_errors(); ?>
