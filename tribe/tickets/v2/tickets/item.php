 ...
 *
 * If RSVP:
 * @var Tribe_TicketsEditor_Template   $this                        [Global] Template object.
 ...
 * @var Tribe_Tickets_Tickets            $provider                    [Global] The tickets provider class.
 * @var string                             $provider_id                 [Global] The tickets provider class name.
 * @var string                             $cart_url                    [Global] Link to Cart (could be empty).
 * @var Tribe_Tickets_Ticket_Object[]    $tickets                     [Global] List of tickets.
 * @var Tribe_Tickets_Ticket_Object[]    $tickets_on_sale             [Global] List of tickets on sale.
 ...
 * @var Tribe_TicketsCommerce_Currency $currency                    [Global] Tribe Currency object.
 * @var Tribe_Tickets_Ticket_Object      $ticket                      The ticket object.
 *
 * If Ticket:
 * @var Tribe_TicketsEditor_Template   $this                        [Global] Template object.
 * @var int                                $post_id                     [Global] The current Post ID to which tickets are attached.
 ...
 * @var bool                               $is_sale_future              [Global] True if no ticket sale dates have started yet.
 * @var Tribe_TicketsCommerce_Currency $currency                    [Global] Tribe Currency object.
 * @var Tribe_Tickets_Tickets_Handler    $handler                     [Global] Tribe Tickets Handler object.
 * @var Tribe_Tickets_Privacy            $privacy                     [Global] Tribe Tickets Privacy object.
...
/* @var Tribe_Tickets_Privacy $privacy */
$privacy = tribe( 'tickets.privacy' );

/** @var Tribe_Tickets_Tickets_Handler $tickets_handler */
 ...
 * @param Tribe_Tickets_Ticket_Object $ticket The ticket object.
 */
