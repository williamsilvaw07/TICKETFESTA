...
function display_html5_qrcode_scanner_shortcode() {
    ...
    jQuery(document).ready(function($) {
        ...
        // Show the "Start Scanning" button initially
        $('#start-scanning-btn').show();

        // Function to handle start scanning button click
        $('#start-scanning-btn').click(function() {
            startScanning();
            // Hide the "Start Scanning" button after clicking
            $(this).hide();
        });
    });
    </script>
EOD;
    ...
    return '<button id="start-scanning-btn">Start Scanning</button>' . $scanner_html . $inline_script;
}
