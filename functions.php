...

function save_event_description($post_id, $post, $update) {
    if (!isset($_POST['event_description'])) return;
    if (defined('DOING_AUTOSAVE') && DOING_AUTOSAVE) return;
    if (!current_user_can('edit_post', $post_id)) return;
    if ($post->post_type !== 'tribe_events') return;

    $event_description = $_POST['event_description']; // Sanitize this as necessary
