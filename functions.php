...
function enqueue_custom_frontend_js()
{
    ...
    echo 'start enquing script';
        ...
        wp_enqueue_script('custom-qr-main-js-10', get_stylesheet_directory_uri() . '/QrScan.js', array('jquery', 'custom-qr-scanner'), $script_version, true);
        wp_localize_script(
