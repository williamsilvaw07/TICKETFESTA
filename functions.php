...
function display_html5_qrcode_scanner_shortcode() {
    ...
    $scanner_html = '<div id="qr-reader" style="max-width: 400px;max-height: 400px;aspect-ratio: 1 / 1;width: 100%;height: auto;position: relative;margin: auto;display: flex; margin-bottom:300px;justify-content: center;align-items: center;padding: 0px;border: 1px solid silver;flex-direction: column;">
