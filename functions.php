...
EOD;
    ...
    return '<div id="qr-reader" style="max-width:400px; max-height:400px; width:100%; aspect-ratio: 1:4; position: relative; margin: 20px auto; overflow: hidden;"></div>' . $inline_script;
}
