...
function display_html5_qrcode_scanner_shortcode() {
    ...
    $scanner_html = '<div class="qr-scanner-wrapper" style="padding: 100px; display: flex; justify-content: center; align-items: center; background-color: #f8f9fa;"> <!-- Additional div wrapper with custom styles -->
