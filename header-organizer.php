...
<body <?php body_class("hold-transition sidebar-mini"); ?> <?php generate_do_microdata('body'); ?>>
...
.admin_dashboard-active a::after {
    ...
    top: 0;
    bottom: 0;
    width: 5px; /* Width of the active border */
    background-color: #d3fa16; /* Color of the active border */
    border-top-right-radius: 4px; /* Optional: if you want rounded corners */
    border-bottom-right-radius: 4px; /* Optional: if you want rounded corners */
}
...
.admin_dashboard-coming-soon, .admin_dashboard-coming-soon a{
cursor: not-allowed;
...
.admin_dashboard-sidebar-item.admin_dashboard-has-submenu > a::after {
    ...
    border-top: 5px solid white; /* The arrow pointing downwards */
}
...
.tribe-attendee-report , .tribe-sales-report{
...
.tribe-list-column-recurring , .tribe-list-column-start_date , .tribe-list-column-end_date{
    display: none;
}
...
*/
.tribe-list-column-category , .tribe-list-column-venue , .tribe-list-column-organizer , .tribe-list-column-title{
    display: flex!important;
    justify-content: center!important;
...
.tickets-sold-column , .gross-column , .status-column , .status-column{
    text-align: center;
}
...
.status-column , .tribe-list-column-venue{
    max-width: 110px;
    width: 100%;
    text-align: center;
}
html .tribe-list-column-start_date , html .tribe-list-column-recurring , html .tribe-list-column-start_date , html .tribe-list-column-end_date {
    display: none!important;
}
.tribe-community-events-list tbody tr{ 
    display: grid;
...
.tribe-community-events-list.display tbody th, .tribe-community-events-list.display tbody td {
    padding-left: 0!important;
...
.event-title-image {
  ...
  .event-title-image .event-link {
    display: flex;
    align-items: center; /* This will ensure the text aligns with the image if wrapped in a link */
  }
  .start-date-label{
    display: none;
  }

  .event-start-date .label ,  .start-date-year{
    display: none;
  }
 ...
 .page-template-organizer-template .start-date-month, .page-template-organizer-template .start-date-day{
    line-height: 15px;
 ...
 .tribe-attendee-report , .row-actions strong{
    display: none!important;
  }
  /***main event lisitng action button****/
.page-template-organizer-template .row-actions , .report_Attendees ,.report_sales {
  display: none;
}
...
#user-organizers-list th, #user-organizers-list td {
    text-align: left;
    padding: 8px;
...
#user-organizers-list tbody tr , #user-organizers-list thead tr{
...
.admin_dashboard_main_amount {
    font-weight: bold;
    color: #4CAF50; /* Or any color you want for the amount */
}
...
.page-template-organizer-template .my-events-display-options , .page-template-organizer-template .table-menu-wrapper:after{
...
.tribe-section-content-field label , .tribe-section-content-label label{
    margin-bottom: 0!important;
}
.recurrence-row{
    display: none!important;
}
.tribe-image-upload-area label , .tribe-image-upload-area .note p , .uploadFile{
    color: black!important;
}
...
.tribe-section-taxonomy , .tribe-section-website  , .tribe-button-icon-settings , #rsvp_form_toggle , .tribe_soft_note , .tribe-section-tickets .accordion {
    display: none!important;
}
...
.tribe-ui-datepicker .ui-state-highlight, .tribe-ui-datepicker.ui-widget-content .ui-state-highlight, .tribe-ui-datepicker .ui-widget-header .ui-state-highlight {
    background: #fff;
...
#rsvp_form_save, #ticket_form_save, #tribe_settings_form_save , .tribe-events-community-footer input{
    margin: 30px auto;
    width: 100%;
    max-width: 400px;
...
.tribe-section-image-uploader .tribe-section-header , .events-community-post-title label{
    display: none!important;
}
...
.events-community-post-title , .event_decp_div{
    display: flex;
    flex-direction: column;
    justify-content: center;
    align-items: flex-start;
...
.events-community-post-title p , .event_decp_div p{
    color: #9d9d9d!important;
}

.event_decp_div h2 , #eventCouponForm .tribe-section-header{
...
.event_decp_div_text_area , .evetm_time_date_div_content{
width: 100%;
}
.hover_section:hover {
    border-color: #d3fa16;
...
.hover_section:hover, .hover_section.clicked-section {
    border-color: #d3fa16; /* This color will remain for clicked sections */
}

/* Ensure the clicked section's border color remains even after hover */
.hover_section.clicked-section {
    border-color: #d3fa16 !important; /* Override any other border color styles */
}
/* Hide by default */
...
.tribe-community-events .tribe-section.tribe-section-image-uploader .tribe-image-upload-area .form-controls , .tribe-section-image-uploader .tribe-remove-upload {
    margin: 0 auto;
    max-width: 250px;
    position: relative;
    width: 100%;
...
.tribe-section-image-uploader .selected-msg , .tribe-section-image-uploader .uploadFile{
    display: none!important;
}
...
.tribe-section-datetime .tribe-section-header , .tribe-section-tickets .tribe-section-header, .tribe-section-venue  .tribe-section-header , .tribe-section-organizer .tribe-section-header {
   display: none; 
}
...
.tribe-section-venue .saved-linked-post , .tribe-section-organizer .saved-linked-post{
display: flex;
flex-direction: column;
}

.tribe-section-venue  .saved-venue-table-cell, .tribe-section-venue tfoot tr td , .tribe-section-organizer tfoot tr td  ,.tribe-section-organizer .edit-linked-post-link , .saved-organizer-table-cell{
    display: none; 
}
...
.tribe-section-organizer , .tribe-section-tickets{
    margin: 0!important;
}
.tribe-section-venue select , .tribe-section-organizer select{
...
#event_tribe_venue, #event_organizer{
    width: 100%!important;
}
...
.tribe-tickets-editor-table tr , .tribe-tickets-editor-table .table-header{
    background-color: #3F3F3F!important;
}
...
.payout_event_list .action_normal_llist , .payout_event_list .event-status-form{
    display: none !important;
}
...
@media (max-width: 768px) {
    ...
    .lower_admin_dashboard-sidebar , .lower_admin_dashboard-sidebar-list{
        width: fit-content;
    ...
    .tribe-list-column-organizer , .gross-column{
       
    }
    .tribe-community-events-list tbody tr , .tribe-community-events-list thead tr{
        grid-gap: 5px;
    }
}
...
.tribe-community-events-list tbody .tribe-list-column-organizer::after ,.tribe-community-events-list tbody .tribe-list-column-title::after{
    padding-left: 5px;
    font-size: 13px;
    font-weight: 300;

}
.tribe-community-events-list tbody .tribe-list-column-title , .tribe-community-events-list tbody .tribe-list-column-organizer{
    font-size: 14px;
    font-weight: 600;
...
.admin_dashboard-active a::after {
    ...
    right: 0;
    top: 0;
    height: 5px; /* This will set the green bar's height */
    left: 0;
    width: 100%;
    background-color: #d3fa16;
...
.page-template-organizer-template h2 , .tribe-community-events-list-title{
...
.admin_dashboard_event_list_nav , .dashboard_main_page_title_div{
...
@media (max-width: 500px) {
    ...
    .live_event_count_admin_dashboard, .live_event_count_admin_dashboard {
...
.admin_dashboard_main_customer_info strong, .admin_dashboard_main_status, .admin_dashboard_main_customer_id, .admin_dashboard_main_retained, .admin_dashboard_main_amount {
    font-size: 15px!important;
